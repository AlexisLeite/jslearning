import { Box, Button, Heading, Table, Tbody, Td, Text, Th, Tr } from "@chakra-ui/react";
...
export default function List() {
  ...
  return <Box sx={{
    ...
    <Text>A continuación se listan todos los usuarios agregados al sistema, haz click en alguno de ellos para ver los detalles:</Text>
    <ul>
      <li>Alexis</li>
      <li>Eduardo</li>
      <li>Pedro</li>
